...
> Do all work in the monorepo: **`~/Developer/bwa-fx-ecosystem/BWA-Output/`**
...
```bash
git subtree push --prefix=BWA-Output git@github.com:vmcguire/BWA-Output.git main
```

Then cut a GitHub Release in this mirror and attach the notarized `BWA-Output.vst3`.
