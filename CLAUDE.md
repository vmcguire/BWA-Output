# BWA-Output — read before doing anything

> ✅ **This is the CANONICAL home for BWA-Output.** All serious DSP, IP, and
> process for this plugin live **here**, in `~/Developer/BWA-Output/`. Author here — always.
>
...
> changes. This file deliberately holds only what is specific to BWA-Output; every
...
4. **`docs/MARKET-PAIN-AND-ATTACKS.md`** — the row for **BWA-Output**; internalize the pain + attack before any DSP.
...
Then cut a GitHub Release here (`vmcguire/BWA-Output`) and attach the notarized `BWA-Output.vst3`.
