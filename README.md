...
LUFS-target output gain. 'Spotify -14' → auto-trims. K-system display alongside.
...
BWA-Output is the final trim stage. LUFS target output gain — pick 'Spotify -14' and the output auto-trims. Integrated meter + K-system display alongside.
...
BWA-Output ships on **two surfaces** — same DSP, different UI:
...
[Releases](https://github.com/vmcguire/BWA-Output/releases). Build from
